...
//                            }
                            ...
                            adapter = new MyAdapter12(listItems, getApplicationContext());
                            recyclerView.setAdapter(adapter);
            ...
            protected String doInBackground(Void... voids) {
                final User user = SharedPrefManager.getInstance(ProductlistActivity.this).getUser();
                ...
                return requestHandler.sendPostRequest(URLs.URL_TABLEPRODUCT, params);
    ...
    private void filter(String text) {
        ...
        ArrayList<User6> filterdlist = new ArrayList<>();

        //looping through existing elements
        for (User6 item : listItems) {
