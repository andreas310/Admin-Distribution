...
public class AddactivationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addactivation);
        ...
        findViewById(R.id.daftarstatus).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(AddactivationActivity.this, android.R.layout.select_dialog_singlechoice);
    ...
    private void userLogin() {
        ...
        class UserLogin extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                ...
                User user = SharedPrefManager.getInstance(AddactivationActivity.this).getUser();
                ...
                return requestHandler.sendPostRequest(URLs.URL_ADDACTIVATION, params);
            }
        }
