    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.daftarstatus).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(AddproductActivity.this, android.R.layout.select_dialog_singlechoice);
    ...
    private void userLogin() {
        ...
        class UserLogin extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                ...
                User user = SharedPrefManager.getInstance(AddproductActivity.this).getUser();
