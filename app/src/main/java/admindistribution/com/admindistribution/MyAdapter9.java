...
public class MyAdapter9 extends RecyclerView.Adapter<MyAdapter9.ViewHolder> {
    ...
    public MyAdapter9(List<User7> listItems, Context context) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.textnama.setText("Rp. " + listItem.getTest());
        holder.textstatus.setText(listItem.getTime());
        holder.texttime.setText(listItem.getRedeem());
        holder.textsales.setText(listItem.getInitial());
        holder.textpoint.setText(listItem.getActid());
        ...
        holder.counstrain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                        ...
                        alertDialog.setMessage("Username : " + listItem.getInitial() + "\nNama Bank : " + listItem.getActid()+"\nKode Bank : " + listItem.getActqr() +
                                "\nNo Rekening : " + listItem.getPoindealer() +"\nNama Pemilik : " + listItem.getName() + "\nClaim : Rp. " + listItem.getTest() + "\nDi Claim Oleh : " + listItem.getSalesname() + "\nRedeem Time : " + listItem.getRedeem() + "\nStatus : " + listItem.getTime());
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            class UserLogin2 extends AsyncTask<Void, Void, String> {
                                                ...
                                                protected String doInBackground(Void... voids) {
                                                    ...
                                                    params.put("redeem_id", listItem.getSerial());
