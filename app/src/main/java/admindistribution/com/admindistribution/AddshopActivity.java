...
public class AddshopActivity extends AppCompatActivity {
    ...
    private TextView daftarnama,daftaremail,daftargambar,daftarstock,daftarstatus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        daftargambar = (TextView) findViewById(R.id.daftargambar);
        daftarstock = (TextView) findViewById(R.id.daftarstock);
        ...
        findViewById(R.id.daftarstatus).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(AddshopActivity.this, android.R.layout.select_dialog_singlechoice);
    ...
    private void userLogin() {
        ...
        if (TextUtils.isEmpty(daftarnama.getText())) {
            daftarnama.setError("Please enter Shop Name");
            daftarnama.requestFocus();
            return;
        }
        if (TextUtils.isEmpty(daftaremail.getText())) {
            daftaremail.setError("Please enter Description");
            daftaremail.requestFocus();
            return;
        }
        if (TextUtils.isEmpty(daftargambar.getText())) {
            daftargambar.setError("Please enter Shop Point");
            daftargambar.requestFocus();
            return;
        }
        if (TextUtils.isEmpty(daftarstock.getText())) {
            daftarstock.setError("Please enter Stock");
            daftarstock.requestFocus();
            return;
        }
        ...
        class UserLogin extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                ...
                User user = SharedPrefManager.getInstance(AddshopActivity.this).getUser();
                String id = user.getAddress();

                //creating request parameters
                HashMap<String, String> params = new HashMap<>();
                params.put("name", daftarnama.getText().toString());
                params.put("description", daftaremail.getText().toString());
                params.put("poin", daftargambar.getText().toString());
                params.put("status", daftarstatus.getText().toString());
                params.put("stock", daftarstock.getText().toString());
                params.put("session_id", id);


                //returing the response
                return requestHandler.sendPostRequest(URLs.URL_ADDSHOP, params);
            }
        }
