...
public class EditshopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        daftaremail.setText(getIntent().getStringExtra("descrip"));
        daftargambar.setText(getIntent().getStringExtra("poin"));
        daftarstock.setText(getIntent().getStringExtra("stock"));
    ...
    private void userLogin() {
        ...
        class UserLogin extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                ...
                User user = SharedPrefManager.getInstance(EditshopActivity.this).getUser();
                ...
                params.put("shop_id", getIntent().getStringExtra("id"));


                //returing the response
                return requestHandler.sendPostRequest(URLs.URL_EDITSHOP, params);
            }
        }
